...
public class FindController {
    ...
    public void find(MainForm mainForm, FindForm findForm) {
        ...
        findForm.getBtnFind().addActionListener((ActionEvent e) -> {
    ...
    public void cancelFind(FindForm findForm) {
        findForm.getBtnCancel().addActionListener((ActionEvent e) -> {
    ...
    public void checkEmptyFind(FindForm findForm) {
        findForm.getTxtFind().addCaretListener((CaretEvent e) -> {
